...
class ResourceTest(APITestCase):
    def test_create_resource(self):
        ...
        resource_attrs = {
            ...
            "endTime": "19:00:00",
            "flyer": img,
            "meetingLink": "https://tufts.zoom.us/j/91768543077?pwd=Wm1JZDJBV2ZZNDI4UXhYVzUvdWE3Zz09",
        ...
        response = self.client.post('/resources', resource_attrs, format='json')
        if response.status_code != 201:
            print("responce for post request", response.status_code)
        self.assertEqual(
...
class ResourceDestroyTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        response = self.client.post('/resources', resource_all_fields, format='json')
    ...
    def test_delete_default_resource(self):
        ...
        response = self.client.delete('/resources/{}'.format(resource_id),format='json')
